...
public class ClientMenu {
    ...
    private static final String BACK_TO_HOME_MENU = "Press [7] To Go Back To The Home Menu\n";

    public static void show() {
        System.out.println("-----Client Administration-----\n");

        System.out.println(NEW_CLIENT + ALL_CLIENTS + FIND_CLIENT_BY_CODE + UPDATE_CLIENT + FIND_CLIENT_BY_ADRESS + DELETE_CLIENT + BACK_TO_HOME_MENU);
    }
