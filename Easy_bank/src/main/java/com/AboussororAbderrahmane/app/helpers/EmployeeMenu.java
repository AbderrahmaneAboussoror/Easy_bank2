package com.AboussororAbderrahmane.app.helpers;
...
public class EmployeeMenu {
    ...
    private static final String BACK_TO_HOME_MENU = "Press [9] To Go Back To The Home Menu\n";

    public static void show() {
        System.out.println("-----Employee Administration-----\n");

        System.out.println(NEW_EMPLOYEE + ALL_EMPLOYEES + FIND_EMPLOYEE_BY_CODE + UPDATE_EMPLOYEE + FIND_EMPLOYEE_BY_PHONE_NUMBER + DELETE_EMPLOYEE + ASSIGN_AN_EMPLOYEE_TO_AN_AGENCY + ASSIGN_AN_EMPLOYEE_TO_ANOTHER_AGENCY + BACK_TO_HOME_MENU);
    }
